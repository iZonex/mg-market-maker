...
const BULLISH: &[&str] = &[
    "surge", "surges", "rally", "rallies", "rallied", "bullish", "breakout",
    "pump", "moon", "ath", "record high", "all-time high", "upgrade",
    "partnership", "adoption", "approved", "approval", "launch", "launches",
    "gain", "gains", "beats", "outperform", "outperforms", "soar", "soars",
    "breakthrough", "positive", "buy", "accumulate", "bull",
];

const BEARISH: &[&str] = &[
    "crash", "crashes", "dump", "plunge", "plunges", "plunged", "bearish",
    "sec", "fine", "fines", "lawsuit", "sued", "hack", "hacked", "exploit",
    "liquidation", "liquidations", "liquidated", "rejection", "rejected",
    "downgrade", "ban", "banned", "drop", "drops", "fall", "falls",
    "fell", "slump", "slumps", "decline", "declines", "fraud", "scam",
    "negative", "sell", "dump", "bear",
];
